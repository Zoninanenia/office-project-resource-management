    ...
    return (
        <div className="space-y-8 animate-fade-in pb-10">
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between items-center px-2">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Link href={`/dashboard/projects/${projectId}/sprints`} className="text-sm font-bold text-cyan-500 hover:text-cyan-400 transition-colors">
                                    Sprints →
                                </Link>
                                ...
                                {teams.map(team => (
                                    <div key={team.teamId} className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-2xl border border-gray-100 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-700 transition-colors">
                                        ...
                                        <div className="flex items-center pl-2">
                                            ...
                                            {
                                                (() => {
                                                    const regularMembers = team.members.filter(m => !team.leader || m.userId !== team.leader.userId);
                                                    return (
                                                        <>
            ...
            <TaskModal
                ...
                projects={[{ projectId: project.projectId, title: project.title }]}
                teams={teams}
                potentialAssignees={potentialAssignees}
                tasks={tasks}
                fixedProjectId={project.projectId.toString()}
            />
        </div>
    );
}
